...
export function DailyTaskModals({
    ...
    return (
        <>
            <Modal
                animationType="slide"
                onRequestClose={onCloseDailyStatus}
                transparent
                visible={dailyStatusVisible && yesterdayTasks.length > 0}>
                            ...
                            {yesterdayTasks.map((task, index) => (
                                <View key={task.id} style={styles.yesterdayItem}>
                                    ...
                                    <View style={styles.yesterdayText}>
                                        ...
                                        <Text style={styles.yesterdayContent}>
                                            {task.content}
                                        </Text>
                                    </View>
                                </View>
